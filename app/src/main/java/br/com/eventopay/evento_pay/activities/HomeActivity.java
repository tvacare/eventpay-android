...
import br.com.eventopay.evento_pay.fragments.CreditoFragment;
import br.com.eventopay.evento_pay.fragments.CriarEventoFragment;
import br.com.eventopay.evento_pay.fragments.EventoFragment;
import br.com.eventopay.evento_pay.fragments.ExtractFragment;
import br.com.eventopay.evento_pay.R;
import br.com.eventopay.evento_pay.fragments.TransacaoFragment;
import br.com.eventopay.evento_pay.model.Evento;
import br.com.eventopay.evento_pay.rest.BaseEndpoint;
import br.com.eventopay.evento_pay.db.EventoDAO;
...
public class HomeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentManager.beginTransaction()
                .replace(R.id.content_frame, new ExtractFragment()).commit();
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        float saldo = preferences.getFloat(getString(R.string.saldo), 0);
        txtExibeSaldo.setText(R.string.currency +" "+saldo);
        return true;
    }
    ...
    public void cadastrarEvento (View view){
        ...
        try {
            ...
            Evento eventoSqlLite = new Evento(usuario, 0, 0,descricao.getText().toString(), nomeEvento.getText().toString());
            EventoDAO sqlDao = new EventoDAO(this);
