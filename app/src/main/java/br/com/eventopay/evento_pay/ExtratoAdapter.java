...
//                    Bitmap bitmap = ((ItemViewHolder) holder).mainLayout.

//                    sendIntent.putExtra(Intent.EXTRA_TEXT, "EVENT PAY - Você foi convidado para o evento "+transacao.getNomeEvento() +" :)");
